...
<div class="container" style="padding-left: 5%; padding-right: 5%;">
    ...
    <div class="row shadow bg-white rounded mb-5" style="border: 1px solid whitesmoke; padding: 0 40px;">
        <table class="table table-borderless mt-4 mb-5">
            <form:form class="form-horizontal" action="${submiturl}"
                ...
                <tr>
                    ...
                    <th style="width: 10%;"></th>
                    <td style="width: 50%">${student.studentId}</td>
                </tr>
                </c:if>
                ...
                <tr>
                    ...
                    <th style="width: 10%;"></th>
                    <td style="width: 50%">
                        <form:input type="date" path="dateOfBirth" class="form-control" required="true" max="2022-01-01" min="1995-01-01"></form:input>
                ...
                <tr>
                    <th style="width: 40%;" >
                        <h4 class="mt-5 mb-5">Edit Guardian Details</h4>
                    </th>
                    <th style="width: 10%;"></th>
                ...
                <tr>
                    ...
                    <th style="width: 10%;"></th>
                    <td style="width: 50%">
                        <button class="btn btn-primary mt-4" type="submit">Go To Next Step </button>
                    </td>
                </tr>
            </form:form>
