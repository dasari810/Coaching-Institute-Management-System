...
<div class="container mt-5 mb-5" style="padding-left: 5%; padding-right: 5%;">
    ...
    <div class="row shadow bg-white rounded" style="border: 1px solid whitesmoke; padding: 0 40px;">
        <table class="table table-borderless mt-4">
            <form:form class="form-horizontal" action="${submiturl}" method="post" modelAttribute="course">
                <tr>
                    <th style="width: 40%;">
                        <h4>${submessage2}</h4>
                    </th>
                ...
                <tr>
                    ...
                    <td style="width: 50%">
                        <c:choose>
                            ...
                            <c:otherwise>
                                <form:input type="text" path="courseId" class="form-control" required="true"></form:input>
