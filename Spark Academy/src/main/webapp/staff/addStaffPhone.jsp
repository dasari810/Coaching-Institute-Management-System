        ...
        <div class="row mt-4 mb-4">
            <div class="col-sm-7 offset-sm-5">
                <sec:authorize access="hasRole('ROLE_ADMIN')">
                    <a class="btn btn-primary" type="button" href="/${role}/staffs/${staffId}">submit</a>
                </sec:authorize>
                <sec:authorize access="!hasRole('ROLE_ADMIN')">
                    <a class="btn btn-primary" type="button" href="/profile/staff">Submit</a>
                </sec:authorize>
            </div>
        </div>
    </div>
